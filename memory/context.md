...
- [Todo] [TASK-147] 2A-3 Evidence Trace: implement EvidenceTrace/Funnel module to identify per-stage survival of each EvidenceKind across Pipeline layers, run on full CN dataset to find where Reduce evidence dies
